...
describe('Blog e2e test', () => {
  ...
  const blogSample = { name: 'scale Metal Joyería', handle: 'Horizontal marco Gorro' };
  ...
  describe('new Blog page', () => {
    ...
    it('should create an instance of Blog', () => {
      cy.get(`[data-cy="name"]`).type('bus GB Blanco').should('have.value', 'bus GB Blanco');

      cy.get(`[data-cy="handle"]`).type('Central').should('have.value', 'Central');
